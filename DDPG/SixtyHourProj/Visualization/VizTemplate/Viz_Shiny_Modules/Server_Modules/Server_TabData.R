    ...
    output_MVSTD_RC)
{
  ...
  theOutputIDs$outputID_TabData_SampleInputInvestorGoals <- rhandsontable::renderRHandsontable({
    theOutput <- shiny::callModule(
      module = Mod_UI_TDa$Mod_Viz_UI_TabData$DisplaySampleInvestorGoals,
      id = "ID_Mod_Viz_UI_TabData_DisplaySampleInvestorGoals",
      data_MVUITD_DSIG = data_MVSTD_RC,
      funcs_MVUITD_DSIG = funcs_MVSTD_RC,
      reactiveInputs_MVUITD_DSIG = reactiveInputs_MVSTD_RC)
  })

    ...
    reactiveVars_MVSTS_RPV)
{
  ...
  theValue <- 23.44 * 10000#shiny::isolate(expr = reactiveVars_MVSTS_RPV[["PortfolioValue"]])
    ...
    reactiveVars_MVSTS_RTV)
{
  ...
  theValue <- 16.94 * 10000#shiny::isolate(expr = reactiveVars_MVSTS_RTV[["TotalValue"]])
  formattedValue <- base::prettyNum(
    x = theValue,
    big.mark = ",", 
    preserve.width = "none")
  ...
  theOutput <- semantic.dashboard::renderValueBox(
    ...
    expr = semantic.dashboard::valueBox(
      value = formattedValue,
      subtitle = "Market Value", #"Total Value"
      icon = semantic.dashboard::icon("dollar"),
      color = "",
      width = 2,
      size = "tiny")
    ...
    reactiveVars_MVSTS_RDLE)
{
  ...
  theOutput <- semantic.dashboard::renderValueBox(
    ...
    expr = semantic.dashboard::valueBox(
      value = "Jan 07, 2020", # formattedValue,
      subtitle = "Date End",#"Date Last Update",
    ...
    reactiveVars_MVSTS_RDLR)
{
  ...
  theOutput <- semantic.dashboard::renderValueBox(
    ...
    expr = semantic.dashboard::valueBox(
      value = "Jan 04, 2010",#"Feb 10, 2020", # formattedValue,
      subtitle = "Date Start",#"Date Last Report",
      icon = semantic.dashboard::icon("calendar alternate outline"),
      color = "",
      width = 2,
      size = "tiny")

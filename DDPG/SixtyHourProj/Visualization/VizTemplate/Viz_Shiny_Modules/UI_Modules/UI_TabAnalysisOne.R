    ...
    funcs_MVUITA1_DC_ST3)
{
  ...
  theUI <- shiny::div(
    ...
    shiny::div(
      ...
      ThirdSubTab_SelectInput_GoalSeries(
        data_MVUITA1_ST3_SI_GS = data_MVUITA1_DC_ST3,
        funcs_MVUITA1_ST3_SI_GS = funcs_MVUITA1_DC_ST3),
    ...
    shiny::div(
      semantic.dashboard::box(
        ...
        width = 8,
        title = "Graphics Goal Series",
        color = "green", 
        ribbon = TRUE, 
        title_side = "top right",
      
        plotly::plotlyOutput(outputId = "outputID_TabAnalysisOne_PlotGoalSeries")),

      #semantic.dashboard::box(
        
      #  width = 8,
      #  title = "Graphics Goal Series One",
      #  color = "green", 
      #  ribbon = TRUE, 
      #  title_side = "top right",
        
      #  plotly::plotlyOutput(outputId = "outputID_TabAnalysisOne_PlotGoalSeriesOne"))
  ...
  funcs_MVUITA1_DC_ST4)
{
  ...
  #  FourthSubTab_SelectInput_GoalSeriesOne(
  #    data_MVUITA1_ST4_SI_GSO = data_MVUITA1_DC_ST4,
  #    funcs_MVUITA1_ST4_SI_GSO = funcs_MVUITA1_DC_ST4),
  ...
  #    shiny::plotOutput(outputId = "outputID_TabAnalysisOne_PlotGoalSeriesOne")),
    
  #  semantic.dashboard::box(
      
  #    width = 8,
  #    title = "Graphics Goal Series Two",
  #    color = "blue", 
  #    ribbon = TRUE, 
  #    title_side = "top right",
      
  #    shiny::plotOutput(outputId = "outputID_TabAnalysisOne_PlotGoalSeriesTwo"))
    
  #)
  
  
  theUI <- shiny::tabPanel( #shiny::div(
    shiny::div(
      class = 'ui large steps', 
      style = 'width: calc(100%); margin: 0px;',
    ...
    shiny::div(
      FourthSubTab_SelectInput_GoalSeriesTwo(
        data_MVUITA1_ST4_SI_GST = data_MVUITA1_DC_ST4,
        funcs_MVUITA1_ST4_SI_GST = funcs_MVUITA1_DC_ST4),
      ...
      semantic.dashboard::box(
        ...
        plotly::plotlyOutput(outputId = "outputID_TabAnalysisOne_PlotGoalSeriesTwo"))
    )
...
ThirdSubTab_SelectInput_GoalSeries <- function(
    data_MVUITA1_ST3_SI_GS,
    funcs_MVUITA1_ST3_SI_GS)
{
  nameFunctionForMessage <- "Mod_Viz_UI_TabAnalysisOne$ThirdSubTab_SelectInput_GoalSeries() "    
  reportr::setOutputLevel(reportr::OL$Error)
  
  theUI <- shiny::selectInput(
    inputId = 'inputID_TabAnalysisOne_ThirdSubTab_SelectGoalSeries', 
    label = 'Select plot',
    multiple = FALSE,
    choices = data_MVUITA1_ST3_SI_GS[["NamesGoalSeries"]],
    selected = c("weights_std"))  
...
FourthSubTab_SelectInput_GoalSeriesOne <- function(
  data_MVUITA1_ST4_SI_GSO,
  funcs_MVUITA1_ST4_SI_GSO)
{
  nameFunctionForMessage <- "Mod_Viz_UI_TabAnalysisOne$FourthSubTab_SelectInput_GoalSeriesOne() "    
  reportr::setOutputLevel(reportr::OL$Error)
  
  theUI <- shiny::selectInput(
    inputId = 'inputID_TabAnalysisOne_FourthSubTab_SelectGoalSeriesOne', 
    label = 'Select value and weight of portfolio',
    multiple = TRUE, #FALSE,
    choices = data_MVUITA1_ST4_SI_GSO[["NamesGoalSeriesOne"]],
    selected = c("portfolio_value", "market_value"))  
  
  return(theUI)
}


FourthSubTab_SelectInput_GoalSeriesTwo <- function(
  data_MVUITA1_ST4_SI_GST,
  funcs_MVUITA1_ST4_SI_GST)
{
  nameFunctionForMessage <- "Mod_Viz_UI_TabAnalysisOne$FourthSubTab_SelectInput_GoalSeriesTwo() "    
  reportr::setOutputLevel(reportr::OL$Error)
  
  theUI <- shiny::selectInput(
    inputId = 'inputID_TabAnalysisOne_FourthSubTab_SelectGoalSeriesTwo', 
    label = 'Select value and weight of portfolio',
    multiple = TRUE, #FALSE,
    choices = data_MVUITA1_ST4_SI_GST[["NamesGoalSeriesTwo"]],
    selected = c("weights1", "weights2","weights3","weights4","weights5","weights6","weights7"))  

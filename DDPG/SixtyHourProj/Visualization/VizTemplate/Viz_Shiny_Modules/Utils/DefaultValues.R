...
SetValues_UserInputs <- function(data_MVDV_SV_UI)
{
  ...
  default_investorCashFlows <- tibble::tibble(
    ...
    Amount = c(1000,1000,1000,1000,1000,1000),#c(10000,15000,-12000,7000,-9000,17000),
    StartDate = c('01/01',#lubridate::as_date('2021-01-01'), 
                  '02/01',#lubridate::as_date('2023-01-01'), 
                  '03/01',#lubridate::as_date('2026-01-01'), 
                  '04/01',#lubridate::as_date('2029-01-01'),
                  '05/01',#lubridate::as_date('2033-01-01'), 
                  '06/01'),#lubridate::as_date('2036-01-01')),
    EndDate = c('01/30',#lubridate::as_date('2022-01-01'), 
                '02/30',#lubridate::as_date('2024-01-01'), 
                '03/30',#lubridate::as_date('2027-01-01'), 
                '04/30',#lubridate::as_date('2030-01-01'),
                '05/30',#lubridate::as_date('2034-01-01'), 
                '06/30'))#lubridate::as_date('2037-01-01')))
  
  defaultValues[["InvestorCashFlows"]] <- default_investorCashFlows
  
  default_investorGoals <- tibble::tibble(
    NameGoal = c("Goal_1"),#c("Goal_1","Goal_2","Goal_3","Goal_4"),
    Amount = c(220000),#c(100000,75000,40000,30000),
    InvestmentHorizon = c('10_years'))
    #StartDate = c(#lubridate::as_date('2021-01-01'), 
                  #lubridate::as_date('2023-01-01'), 
                  #lubridate::as_date('2021-01-01'), 
                  #lubridate::as_date('2027-01-01')),
    #EndDate = c(lubridate::as_date('2024-01-01'), 
    #            lubridate::as_date('2033-01-01'), 
    #            lubridate::as_date('2031-01-01'), 
    #            lubridate::as_date('2047-01-01')))
